...
{
    /// <summary>
    /// ReportMlFilepathAnalyzedCountsNeighborMaliciousness
    /// </summary>
    [DataContract]
        public partial class ReportMlFilepathAnalyzedCountsNeighborMaliciousness :  IEquatable<ReportMlFilepathAnalyzedCountsNeighborMaliciousness>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportMlFilepathAnalyzedCountsNeighborMaliciousness" /> class.
        /// </summary>
        /// <param name="benign">benign (required).</param>
        /// <param name="malware">malware (required).</param>
        public ReportMlFilepathAnalyzedCountsNeighborMaliciousness(int? benign = default(int?), int? malware = default(int?))
        {
            // to ensure "benign" is required (not null)
            if (benign == null)
            {
                throw new InvalidDataException("benign is a required property for ReportMlFilepathAnalyzedCountsNeighborMaliciousness and cannot be null");
            }
            else
            {
                this.Benign = benign;
            ...
            if (malware == null)
            {
                throw new InvalidDataException("malware is a required property for ReportMlFilepathAnalyzedCountsNeighborMaliciousness and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReportMlFilepathAnalyzedCountsNeighborMaliciousness {\n");
        ...
        {
            return this.Equals(input as ReportMlFilepathAnalyzedCountsNeighborMaliciousness);
        }

        /// <summary>
        /// Returns true if ReportMlFilepathAnalyzedCountsNeighborMaliciousness instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportMlFilepathAnalyzedCountsNeighborMaliciousness to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportMlFilepathAnalyzedCountsNeighborMaliciousness input)
        {
            if (input == null)
                return false;

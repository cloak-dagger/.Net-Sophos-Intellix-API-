...
namespace SophosLabs.Intellix.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReportMlFileAnalyzedCountsFeatureMaliciousness :  IEquatable<ReportMlFileAnalyzedCountsFeatureMaliciousness>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportMlFileAnalyzedCountsFeatureMaliciousness" /> class.
        /// </summary>
        ...
        public ReportMlFileAnalyzedCountsFeatureMaliciousness(int? benign = default(int?), int? malware = default(int?))
        {
            // to ensure "benign" is required (not null)
            if (benign == null)
            {
                throw new InvalidDataException("benign is a required property for ReportMlFileAnalyzedCountsFeatureMaliciousness and cannot be null");
            }
            else
            {
                this.Benign = benign;
            ...
            if (malware == null)
            {
                throw new InvalidDataException("malware is a required property for ReportMlFileAnalyzedCountsFeatureMaliciousness and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReportMlFileAnalyzedCountsFeatureMaliciousness {\n");
        ...
        {
            return this.Equals(input as ReportMlFileAnalyzedCountsFeatureMaliciousness);
        }

        /// <summary>
        /// Returns true if ReportMlFileAnalyzedCountsFeatureMaliciousness instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportMlFileAnalyzedCountsFeatureMaliciousness to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportMlFileAnalyzedCountsFeatureMaliciousness input)
        {
            if (input == null)
                return false;

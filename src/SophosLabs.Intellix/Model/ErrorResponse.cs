...
namespace SophosLabs.Intellix.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ErrorResponse : GenericResponse,  IEquatable<ErrorResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorResponse" /> class.
        /// </summary>
        /// <param name="error">A camelCase identifier for the error condition. .</param>
        /// <param name="message">An English string explaining the error. .</param>
        /// <param name="createdAt">The ISO 8601 UTC timestamp for when the error object was created. .</param>
        public ErrorResponse(string error = default(string), string message = default(string), string createdAt = default(string), string correlationId = default(string), string requestId = default(string)) : base(correlationId, requestId)
        {
            this.Error = error;
        ...
        /// <summary>
        /// An English string explaining the error. 
        /// </summary>
        /// <value>An English string explaining the error. </value>

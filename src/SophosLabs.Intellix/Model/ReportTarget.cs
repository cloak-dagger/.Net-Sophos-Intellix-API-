...
namespace SophosLabs.Intellix.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReportTarget :  IEquatable<ReportTarget>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportTarget" /> class.
        /// </summary>
        /// <param name="mimeType">mimeType (required).</param>
        /// <param name="sha1">sha1 (required).</param>
        /// <param name="sha256">sha256 (required).</param>
        public ReportTarget(string mimeType = default(string), string sha1 = default(string), string sha256 = default(string))
        {
            // to ensure "mimeType" is required (not null)
            if (mimeType == null)
            {
                throw new InvalidDataException("mimeType is a required property for ReportTarget and cannot be null");
            }
            else
            {
            ...
            if (sha1 == null)
            {
                throw new InvalidDataException("sha1 is a required property for ReportTarget and cannot be null");
            }
            else
            {
                this.Sha1 = sha1;
            ...
            if (sha256 == null)
            {
                throw new InvalidDataException("sha256 is a required property for ReportTarget and cannot be null");
            }
            else
            {
                this.Sha256 = sha256;
        ...
        {
            return this.Equals(input as ReportTarget);
        }

        /// <summary>
        /// Returns true if ReportTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportTarget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportTarget input)
        {
            if (input == null)
                return false;

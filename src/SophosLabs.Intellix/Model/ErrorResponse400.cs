...
namespace SophosLabs.Intellix.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ErrorResponse400 : GenericResponse,  IEquatable<ErrorResponse400>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorResponse400" /> class.
        /// </summary>
        ...
        public ErrorResponse400(string requestId = default(string), string createdAt = default(string), string error = default(string), string correlationId = default(string)) : base(correlationId)
        {
        ...
        {
            return this.Equals(input as ErrorResponse400);
        }

        /// <summary>
        /// Returns true if ErrorResponse400 instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorResponse400 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorResponse400 input)
        {
            if (input == null)
                return false;

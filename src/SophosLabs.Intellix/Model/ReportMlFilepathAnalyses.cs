...
{
    /// <summary>
    /// ReportMlFilepathAnalyses
    /// </summary>
    [DataContract]
        public partial class ReportMlFilepathAnalyses :  IEquatable<ReportMlFilepathAnalyses>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportMlFilepathAnalyses" /> class.
        /// </summary>
        /// <param name="neighborMaliciousness">neighborMaliciousness.</param>
        public ReportMlFilepathAnalyses(ReportMlFilepathAnalysesNeighborMaliciousness neighborMaliciousness = default(ReportMlFilepathAnalysesNeighborMaliciousness))
        {
        ...
        public ReportMlFilepathAnalysesNeighborMaliciousness NeighborMaliciousness { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReportMlFilepathAnalyses {\n");
        ...
        {
            return this.Equals(input as ReportMlFilepathAnalyses);
        }

        /// <summary>
        /// Returns true if ReportMlFilepathAnalyses instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportMlFilepathAnalyses to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportMlFilepathAnalyses input)
        {
            if (input == null)
                return false;

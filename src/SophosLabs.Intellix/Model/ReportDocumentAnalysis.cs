...
{
    /// <summary>
    /// ReportDocumentAnalysis
    /// </summary>
    [DataContract]
        public partial class ReportDocumentAnalysis :  IEquatable<ReportDocumentAnalysis>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportDocumentAnalysis" /> class.
        /// </summary>
        /// <param name="metaData">metaData (required).</param>
        public ReportDocumentAnalysis(ReportDocumentAnalysisMetaData metaData = default(ReportDocumentAnalysisMetaData))
        {
            // to ensure "metaData" is required (not null)
            if (metaData == null)
            {
                throw new InvalidDataException("metaData is a required property for ReportDocumentAnalysis and cannot be null");
            }
            else
            {
        ...
        public ReportDocumentAnalysisMetaData MetaData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReportDocumentAnalysis {\n");
        ...
        {
            return this.Equals(input as ReportDocumentAnalysis);
        }

        /// <summary>
        /// Returns true if ReportDocumentAnalysis instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportDocumentAnalysis to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportDocumentAnalysis input)
        {
            if (input == null)
                return false;

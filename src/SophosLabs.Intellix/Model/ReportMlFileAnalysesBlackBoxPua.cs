...
{
    /// <summary>
    /// How likely the file is to be PUA (Potentially Unwanted Application). The structure of this section is the same as ml_file.analyses.black_box.benign, but the scores here represent PUA likelihoods. A higher score means more likely. Note that this is only currently relevant for our PE SLAP container. 
    /// </summary>
    [DataContract]
        public partial class ReportMlFileAnalysesBlackBoxPua :  IEquatable<ReportMlFileAnalysesBlackBoxPua>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportMlFileAnalysesBlackBoxPua" /> class.
        /// </summary>
        /// <param name="raw">raw (required).</param>
        /// <param name="score">score (required).</param>
        public ReportMlFileAnalysesBlackBoxPua(decimal? raw = default(decimal?), decimal? score = default(decimal?))
        {
            // to ensure "raw" is required (not null)
            if (raw == null)
            {
                throw new InvalidDataException("raw is a required property for ReportMlFileAnalysesBlackBoxPua and cannot be null");
            }
            else
            {
                this.Raw = raw;
            ...
            if (score == null)
            {
                throw new InvalidDataException("score is a required property for ReportMlFileAnalysesBlackBoxPua and cannot be null");
            }
            else
            {
                this.Score = score;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReportMlFileAnalysesBlackBoxPua {\n");
        ...
        {
            return this.Equals(input as ReportMlFileAnalysesBlackBoxPua);
        }

        /// <summary>
        /// Returns true if ReportMlFileAnalysesBlackBoxPua instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportMlFileAnalysesBlackBoxPua to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportMlFileAnalysesBlackBoxPua input)
        {
            if (input == null)
                return false;

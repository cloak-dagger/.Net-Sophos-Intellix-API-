...
{
    /// <summary>
    /// ReportMlAggregateResults
    /// </summary>
    [DataContract]
        public partial class ReportMlAggregateResults :  IEquatable<ReportMlAggregateResults>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportMlAggregateResults" /> class.
        /// </summary>
        /// <param name="overallScore">This section contains an overall_score from 0-100 representing all of the analyses scores, combined together. This is generally seen to be the most accurate representation of the customer&#x27;s submitted file / file-path.  (required).</param>
        public ReportMlAggregateResults(decimal? overallScore = default(decimal?))
        {
            // to ensure "overallScore" is required (not null)
            if (overallScore == null)
            {
                throw new InvalidDataException("overallScore is a required property for ReportMlAggregateResults and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// This section contains an overall_score from 0-100 representing all of the analyses scores, combined together. This is generally seen to be the most accurate representation of the customer&#x27;s submitted file / file-path. 
        /// </summary>
        /// <value>This section contains an overall_score from 0-100 representing all of the analyses scores, combined together. This is generally seen to be the most accurate representation of the customer&#x27;s submitted file / file-path. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReportMlAggregateResults {\n");
        ...
        {
            return this.Equals(input as ReportMlAggregateResults);
        }

        /// <summary>
        /// Returns true if ReportMlAggregateResults instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportMlAggregateResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportMlAggregateResults input)
        {
            if (input == null)
                return false;
